...
async def order_book():
    ...
    try:
        ...
        position = await connection.position_information(symbol="SOLUSDT")

        pprint(f"Position Information: {position.data()}")

        position = await connection.position_information_v2(symbol="SOLUSDT")
